...
<br />Enjoy the feeling of knowing that you helped save precious lives!</p>
            ...
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                     ...
                     <!-- <td style="float:right; padding-bottom:900px; padding-left:90px">  <a href="index1.php"><img src="Images/regdonor.png" width="500px" height="350px"  /><br /><br /></br></br><br /><br /></a></td>-->
...
<div class="footer">
	<div class="f_nav">
		<ul>
			...
			<li class="active"><a href="donar.php">Donor Instructions</a></li>
